    ...
    >
      ...
      <div className="flex flex-col flex-1 min-w-0">
        <div className="flex gap-2 items-center flex-wrap mb-1">
          ...
          >
            {todo.isPinned ? (
              <BookmarkIconSolid className="w-4 h-4 mr-1.5 text-yellow-500 shrink-0" />
            ) : null}
            {todo.title}
          </span>
        ...
        <div className="flex items-center gap-3 text-xs mt-0.5">
          ...
          {todo.dueDate && (
            ...
            >
              ...
              {new Date(todo.dueDate).toLocaleString("vi-VN", {
                hour: "2-digit",
                minute: "2-digit",
                day: "2-digit",
                month: "2-digit",
          ...
          {todo.steps && todo.steps.length > 0 && (
            <span className="text-gray-500 flex items-center gap-1">
              {todo.steps.filter((s) => s.isCompleted).length}/{todo.steps.length} bước
            </span>
          )}
        </div>
      </div>
