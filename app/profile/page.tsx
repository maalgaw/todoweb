...
export default function ProfilePage() {
 ...
 const msg =
 (uploadError as Error).message || "Lỗi khi tải ảnh lên Supabase";
 ...
 >
 <ArrowLeftIcon className="w-5 h-5" /> Quay lại trang chủ
 </Link>
 ...
 className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 cursor-pointer text-white"
 >
 ...
 onClick={handleSave}
 disabled={isLoading}
 className="px-6 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-medium rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 disabled:opacity-50 "
 >
