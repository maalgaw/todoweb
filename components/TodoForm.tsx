...
export default function TodoForm({ categories, onAdd }: Props) {
 ...
 <div
 ref={formRef}
 className="flex items-center gap-3 bg-white rounded-xl px-4 py-3 shadow-sm border border-gray-200 focus-within:border-emerald-500 focus-within:ring-1 focus-within:ring-emerald-500 relative"
 >
 <button
 onClick={handleAdd}
 ...
 className={`p-1.5 rounded-md hover:bg-gray-100 ${newCategoryId ? "text-emerald-600 bg-emerald-50" : "text-gray-500"}`}
 title="Thẻ phân loại"
 >
 ...
 className={`w-full text-left px-4 py-2 text-sm ${newCategoryId === "" ? "bg-emerald-50 text-emerald-700 font-medium" : "text-gray-700 hover:bg-gray-50"}`}
 >
 Không có thẻ
 </button>
 {categories.map((c) => (
 ...
 className={`w-full text-left px-4 py-2 text-sm ${newCategoryId === c.id ? "bg-emerald-50 text-emerald-700 font-medium" : "text-gray-700 hover:bg-gray-50"}`}
 >
 {c.name}
 </button>
 ))}
 ...
 className={`p-1.5 rounded-md hover:bg-gray-100 ${newPriority == 1 ? "text-amber-500 bg-amber-50" : newPriority == 2 ? "text-red-400 bg-red-50" : "text-gray-500"}`}
 title="Độ ưu tiên"
 >
 ...
 className={`w-full text-left px-4 py-2 text-sm ${newPriority === p.value ? "bg-amber-50 text-amber-700 font-medium" : "text-gray-700 hover:bg-gray-50"}`}
 >
 {p.label}
 </button>
 ))}
 ...
 className={`p-1.5 rounded-md hover:bg-gray-100 ${newDueDate ? "text-emerald-600 bg-emerald-50" : "text-gray-500"}`}
 title="Ngày đến hạn"
 >
