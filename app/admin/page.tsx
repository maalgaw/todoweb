      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-4 sm:p-6 lg:p-8 mt-4">
        <div className="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <div className="w-full sm:w-auto flex flex-col sm:flex-row items-center gap-3">
            ...
            <button
              onClick={logout}
              className="px-4 py-2 bg-red-50 hover:bg-red-100 text-red-600 rounded-xl font-medium text-sm w-full sm:w-auto flex items-center justify-center gap-2"
            >
                  ...
                  <tr key={u.id} className="hover:bg-slate-50/80 group">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-slate-100 border border-slate-200 flex items-center justify-center overflow-hidden shrink-0 shadow-sm group-hover:shadow-md ">
                          {u.avatarUrl ? (
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-center gap-2 opacity-100 sm:opacity-70 group-hover:opacity-100 ">
                        <button
                          onClick={() => {
                            setEditingUser(u);
                            setNewPassword("");
                          ...
                          className="px-4 py-1.5 bg-indigo-50 hover:bg-indigo-100 text-indigo-600 rounded-full text-xs font-semibold hover:scale-105 active:scale-95"
                        >
                          Sửa
                        </button>
                        <button
            ...
            <form onSubmit={handleUpdateUser} className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 text-sm outline-none "
              ...
              <div className="pt-6 flex justify-end gap-3 border-t border-slate-100 mt-6">
                ...
                <button
                  type="submit"
                  className="px-6 py-2.5 text-sm font-bold text-white bg-emerald-600 hover:bg-emerald-500 hover:shadow-lg hover:shadow-emerald-500/30 rounded-xl active:scale-95"
                >
                  Lưu thay đổi
                </button>
              </div>
