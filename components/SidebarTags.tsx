...
export default function SidebarTags({
 ...
 <ChevronUpIcon className={`w-4 h-4 ${isCategoriesOpen ? "rotate-180" : ""}`} />
 </button>
 </div>
 ...
 className="w-full pl-3 pr-8 py-1.5 bg-gray-100 border-transparent rounded-md text-sm focus:bg-white focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 "
 />
 <button
 onClick={handleAddCategory}
 className="absolute right-1 top-1/2 transform -translate-y-1/2 p-1 text-gray-400 hover:text-emerald-600 opacity-0 group-hover:opacity-100 "
 title="Thêm thẻ"
 >
 ...
 className={`flex-1 flex items-center gap-3 px-3 py-2 rounded-md text-sm ${
